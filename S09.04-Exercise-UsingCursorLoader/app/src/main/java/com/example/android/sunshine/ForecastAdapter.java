...
//      COMPLETED (7) Generate a weather summary with the date, description, high and low
        String weatherForThisDay =  generateWeatherSummary(
...
//      COMPLETED (8) Display the summary that you created above
    ...
    private String generateWeatherSummary(long date, int weatherId, double high, double low) {
        ...
        return dateStr + " - " + description + " - " + highAndLow;
    }
...
//      COMPLETED (12) After the new Cursor is set, call notifyDataSetChanged
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            String weatherForDay =  generateWeatherSummary(
                    mCursor.getLong(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_DATE)),
                    mCursor.getInt(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID)),
                    mCursor.getDouble(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP)),
                    mCursor.getDouble(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP)));
