...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        String preferredLocation = SunshinePreferences.PREF_CITY_NAME;
        URL queryUrl = NetworkUtils.buildUrl(preferredLocation);
    ...
    private class FetchWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            String res = null;
            try {
                res = NetworkUtils.getResponseFromHttpUrl(queryUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
            return res;
